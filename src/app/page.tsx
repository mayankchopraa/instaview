          ...
          <div className="mt-9 flex flex-col items-center justify-center gap-3 sm:flex-row">
            {loading ? (
              ...
              <>
                <Link
                  href="/signup"
                  className="max-w-md block w-full max-w-md rounded-lg bg-[#6C5CE7] px-8 py-4 text-center text-sm font-semibold text-white hover:bg-[#5848D6] transition-colors"
                >
